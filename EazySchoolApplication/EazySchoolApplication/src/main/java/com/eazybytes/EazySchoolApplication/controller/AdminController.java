...
import com.eazybytes.EazySchoolApplication.model.Courses;
...
public class AdminController {
    ...
    public ModelAndView addNewClass(@ModelAttribute(value="eazyClass") EazyClass eazyClass){
    ...
    public ModelAndView addStudent(Model model,@ModelAttribute(value="person") Person person,HttpSession session){
    ...
    public ModelAndView displayCourses(Model model){
        //findByOrderByName example of static sorting
      //  List<Courses> courses = coursesRepository.findByOrderByName();
        //Sort class used for dynamic sorting provided by SPRING DATA JPA
    ...
    public ModelAndView deleteCourse(Model model, @RequestParam int id, HttpSession session) {
